            ...
            <input type="hidden" id="id" name="id" value="{{isset($singleData['id']) ? $singleData['id'] : ''}}"/>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="ward_name" name="ward_name" class="form-control form-control-solid" value="{{isset($singleData['ward_name']) ? $singleData['ward_name'] : ''}}" />
                    </div>
                    <div class="col-md-4">
                        <label class="required fs-6 fw-semibold mb-1 ms-1">Ward Number</label>
                        <input type="text" id="ward_number" name="ward_number" class="form-control form-control-solid" value="{{isset($singleData['ward_number']) ? $singleData['ward_number'] : ''}}" />
                    </div>
                </div>
                <hr>
                <div>
