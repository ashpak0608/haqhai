                  ...
                  <div class="mb-0">
                     <div class="card-block">
                        <div class="ex-page-content text-center">
                           ...
                           <h1 class="text-primary">5<i class="far fa-meh-rolling-eyes text-danger ml-1 mr-1"></i>4</h1>
                           <h5>Gateway Timeout</h5>
                           <br />
                           <a class="btn btn-primary mb-5 waves-effect waves-light" href="javascript:void(0);" onclick="history.back()"><i class="ion ion-md-arrow-round-back mr-2"></i>Back to Previous Page</a>
                        </div>
                     </div>
                  </div>
               </div>
