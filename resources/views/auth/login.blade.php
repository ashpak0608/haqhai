...
<html lang="en">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('assets/media/auth/bg12-dark.jpg'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg4-dark.jpg'); }</style>
			<!--end::Page bg image-->
		...
		<script src="{{url('validation/common.js')}}"></script>
		<script src="{{url('validation/login.js')}}"></script>
        <!--end::Javascript-->
	</body>
	<!--end::Body-->
</html>