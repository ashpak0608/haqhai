    ...
    <div class="card-body pt-4 pb-0">
        <div class="d-row row-wrap row-sm-nowrap pb-4">
            <form id="view_from" name="view_from" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                ...
                <hr>
                <div class="row">
                    <label class="col-lg-4 fw-semibold text-muted">Sub Menu</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">Sub Menu 1</span>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <label class="col-lg-4 fw-semibold text-muted">Access Permissions</label>
                    <div class="col-lg-8 fv-row">
                        <span class="fw-semibold text-gray-800 fs-6">
                            <span class="badge badge-light-success fs-7 fw-bold">Insert</span>
                            <span class="badge badge-light-info fs-7 fw-bold">Edit</span>
                            <span class="badge badge-light-primary fs-7 fw-bold">View</span>
                            <span class="badge badge-light-danger fs-7 fw-bold">Delete</span>
                        </span>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">Created By 1</span>
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">Modified By 1</span>
                    </div>
                </div>
                <hr>
                <div class="row">
