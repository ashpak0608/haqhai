        ...
        <div class="d-row row-wrap row-sm-nowrap pb-4">
            <form id="search_from" name="search_from" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label class="fs-6 fw-semibold mb-1 ms-1">Phone 1</label>
                        <input type="text" id="phone_1" name="phone_1" class="form-control form-control-solid" />
                        <span class="text-danger" id="phone_1_error"></span>
                    </div>
                </div>
                <hr>
                <div>
