    ...
    <div id="kt_app_toolbar_container" class="container-fluid d-flex align-items-stretch">
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ url('city') }}" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold">
...
<div class="card mb-4">
    <div class="card-body pt-4 pb-0">
        <div class="d-row row-wrap row-sm-nowrap pb-4">
            <form id="city_form" name="city_form" method="post" action="{{ url('city/save') }}" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="city_name" name="city_name" class="form-control form-control-solid" value="{{ old('city_name', isset($singleData['city_name']) ? $singleData['city_name'] : '') }}" required />
                        @error('city_name')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <a href="{{ url('city') }}" class="btn btn-sm btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#district_id, #city_name').on('input change', function() {
