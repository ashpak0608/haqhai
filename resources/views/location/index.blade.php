            ...
            <table id="table_content" name="table_content" class="table align-middle table-row-dashed fs-6 gy-5">
                ...
                @foreach($lists as $key => $list)
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('location/add/'.$list->id);?>" class="btn btn-icon btn-active-light-info w-30px h-30px me-3"><i class="ki-outline ki-pencil text-info fs-3"></i></a>
                            <a href="<?php echo url('location/view/'.$list->id);?>" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3"><i class="ki-outline ki-eye text-primary fs-3"></i></a>
